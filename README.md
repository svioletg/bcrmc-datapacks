...
patch number all joined by hyphens, e.g. `bcrmc-26.3snap1`, `bcrmc-26.3`, or `bcrmc-26.3-1`. The
last additional prefix is only added when an update is made to a datapack where the supported
Minecraft version has not changed.
